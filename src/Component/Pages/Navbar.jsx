...
const Navbar = () => {
  ...
  useEffect(()=>{
    ...
    const navLinks = <>
        ...
        <li><NavLink  className=' text-lg' to='/allBook'> All Book </NavLink></li>
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <img className=" w-32 md:w-40  " src="https://www.library-management.com/uploads/60196c0c6f3a8_logo_.png" alt="" />
        </div>
